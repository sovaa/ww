...
public class IntShuffleBag {
     ...
     * @exception IllegalArgumentException if the specified initial capacity is negative
     */
    public IntShuffleBag(Random gen){
        this(10, gen);
    }
    /**
     ...
     * @exception IllegalArgumentException if the specified initial capacity is negative
     */
    public IntShuffleBag(int capacity, Random gen){
        if(capacity<0)
    ...
    /**
     * Trims the capacity of this <tt>IntShuffleBag</tt> instance to be the
     * bag's current size. Use this to minimize
     * the storage of a <tt>IntShuffleBag</tt> instance.
     */
