...
public class Commands {
    ...
    public static final String[] QUESTS     = {"org/eldslott/ww/quests", "q"};
    ...
    public static final String[] MAP        = {"org/eldslott/ww/map", "m"};
    public static final String[] TRADE      = {"trade"};
    public static final String[] CHARACTER  = {"org/eldslott/ww/character", "c"};
    public static final String[] WALK       = {"walk", "w"};
    public static final String[] REPUTATION = {"org/eldslott/ww/reputation", "p"};
